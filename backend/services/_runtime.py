...
from services.runtime_packages import (
    create_backup,
    create_diagnostics_zip as _create_diagnostics_zip,
    list_backups,
    restore_backup,
)
...
def create_diagnostics_zip() -> dict:
    payload = self_check_payload if "self_check_payload" in globals() else None
    return _create_diagnostics_zip(self_check_payload=payload)
